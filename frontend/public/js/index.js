...
axios.CancelToken = __webpack_require__(903);
...
;// CONCATENATED MODULE: ./src/config/axios.js

var axios_clientAxios = axios_default().create({
  baseURL: "http://localhost:4000"
});
/* harmony default export */ const config_axios = (axios_clientAxios);
;// CONCATENATED MODULE: ./src/js/components/Patients.js



var Patients_Patients = function Patients(_ref) {
  var quote = _ref.quote;
  if (quote.length === 0) return null;
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("h1", {
    className: "my-5"
  }, "Administrator Patients"), /*#__PURE__*/React.createElement("div", {
  ...
  }, quote.map(function (q) {
    return /*#__PURE__*/React.createElement(Link, {
      to: "/quote/".concat(q._id),
      key: q._id,
      className: "P-5 list-group-item list-group-item-action flex-column align-itmes-start"
    }, /*#__PURE__*/React.createElement("div", {
      className: "d-flex w-100 justify-content-between mb-4"
    }, /*#__PURE__*/React.createElement("h3", {
      className: "mb-3"
    }, q.name), /*#__PURE__*/React.createElement("small", {
      className: "fecha-alta"
    }, q.date, " - ", q.hour)), /*#__PURE__*/React.createElement("p", {
      className: "mb-0"
    }, q.symptoms), /*#__PURE__*/React.createElement("div", {
      className: "contacto py-3"
    }, /*#__PURE__*/React.createElement("p", null, "Owner: ", q.owner), /*#__PURE__*/React.createElement("p", null, "Phone: ", q.phone)));
  }))))));
};

/* harmony default export */ const components_Patients = ((/* unused pure expression or super */ null && (Patients_Patients)));
...
function withRouter(Component) {
  ...
  var C = function C(props) {
    ...
    return react.createElement(context.Consumer, null, function (context) {
      !context ?  false ? 0 : tiny_invariant_esm(false) : void 0;
      return react.createElement(Component, extends_extends({}, remainingProps, context, {
...
;// CONCATENATED MODULE: ./src/js/components/NewQuote.js
...
var NewQuote_NewQuote = function NewQuote(props) {
  ...
  var _useState = (0,react.useState)({
    ...
    symptoms: ''
      ...
      quote = _useState2[0],
      setQuote = _useState2[1]; // read data from form


  var updateState = function updateState(e) {
    setQuote(_objectSpread(_objectSpread({}, quote), {}, defineProperty_default()({}, e.target.name, e.target.value)));
  }; //send a request to API


  var createNewQuote = function createNewQuote(e) {
    e.preventDefault(); //send request with axios

    config_axios.post('/patients', quote).then(function (res) {
      console.log(res);
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("h1", {
    ...
    className: "col-12 mb-5 d-flex justify-content-center"
  }, /*#__PURE__*/react.createElement(react_router_dom_Link, {
    to: '/',
    className: "btn btn-success text-uppercase py-2 px-5 font-weight-bold"
    ...
    htmlFor: "nombre"
  }, "Name Pets"), /*#__PURE__*/react.createElement("input", {
    type: "text",
    ...
    htmlFor: "propietario"
  }, "Name Owner"), /*#__PURE__*/react.createElement("input", {
    type: "text",
    className: "form-control form-control-lg",
    id: "propietario",
    name: "owner",
...
/* harmony default export */ const components_NewQuote = (withRouter(NewQuote_NewQuote)); // AWS, lambdas, DynamoDB, S3,
// EXTERNAL MODULE: ./node_modules/sweetalert2/dist/sweetalert2.all.js
var sweetalert2_all = __webpack_require__(455);
var sweetalert2_all_default = /*#__PURE__*/__webpack_require__.n(sweetalert2_all);
;// CONCATENATED MODULE: ./src/js/components/Quote.js





var Quote_Quote = function Quote(props) {
  if (!props.getQuote) {
    props.history.push('/');
    return null;
  } //stract data quote
  ...
  var _props$getQuote = props.getQuote,
      name = _props$getQuote.name,
      owner = _props$getQuote.owner,
      hour = _props$getQuote.hour,
      phone = _props$getQuote.phone,
      date = _props$getQuote.date,
      symptoms = _props$getQuote.symptoms,
      _id = _props$getQuote._id; //delete Quote
  ...
  var deleteQuote = function deleteQuote(id) {
    ...
    sweetalert2_all_default().fire({
      ...
      if (result.isConfirmed) {
        // alert delete
        sweetalert2_all_default().fire('Deleted!', 'Your file has been deleted.', 'success'); //call the API

        config_axios.delete("/patients/".concat(id)).then(function (res) {
          props.setRequestC(true);
          props.history.push('/');
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("h1", null, "Name Quote: ", name), /*#__PURE__*/react.createElement("div", {
    className: "container mt-5 py-5"
  }, /*#__PURE__*/react.createElement("div", {
    className: "row"
  }, /*#__PURE__*/react.createElement("div", {
    ...
    className: "p-5 list-group-item list-group-item-action flex-column align-items-center"
  }, /*#__PURE__*/react.createElement("div", {
    className: "d-flex w-100 justify-content-between mb-4"
  }, /*#__PURE__*/react.createElement("h3", {
    className: "mb-3"
    ...
    className: "fecha-alta"
  }, date, " - ", hour)), /*#__PURE__*/react.createElement("p", {
    className: "mb-0"
  }, symptoms), /*#__PURE__*/react.createElement("div", {
    className: "contacto py-3"
  }, /*#__PURE__*/react.createElement("p", null, "Owner: ", owner), /*#__PURE__*/react.createElement("p", null, "Phone: ", phone)), /*#__PURE__*/react.createElement("div", {
    className: "d-flex"
  }, /*#__PURE__*/react.createElement("button", {
    type: "button",
    className: "text-uppercase py-2 px-5 font-weight-bold btn btn-danger col",
    onClick: function onClick() {
      return deleteQuote(_id);
    }
  }, "Delete \xD7"))))))));
};

/* harmony default export */ const components_Quote = (withRouter(Quote_Quote));
...
var App = function App() {
  ...
  var _useState3 = useState(true),
      ...
      requestC = _useState4[0],
      setRequestC = _useState4[1];

  useEffect(function () {
    if (requestC) {
      var consultAPI = function consultAPI() {
        clientAxios.get('/patients').then(function (res) {
          setQuote(res.data);
          setRequestC(false);
        })["catch"](function (err) {
  ...
  return /*#__PURE__*/React.createElement(Router, null, /*#__PURE__*/React.createElement(Switch, null, /*#__PURE__*/React.createElement(Route, {
    ...
    path: "/new",
    component: function component() {
      return /*#__PURE__*/React.createElement(NewQuote, {
        setRequestC: setRequestC
      });
    }
  }), /*#__PURE__*/React.createElement(Route, {
    exact: true,
    ...
    render: function render(props) {
      var getQuote = quote.filter(function (q) {
        return q._id === props.match.params.id;
      });
 ...
 * LICENSE file in the root directory of this source tree.
 */
var l=__webpack_require__(418),n=60103,p=60106;exports.Fragment=60107;__webpack_unused_export__=60108;__webpack_unused_export__=60114;var q=60109,r=60110,t=60112;__webpack_unused_export__=60113;var u=60115,v=60116;
...
exports.Children={map:P,forEach:function(a,b,c){P(a,function(){b.apply(this,arguments)},c)},count:function(a){var b=0;P(a,function(){b++});return b},toArray:function(a){return P(a,function(a){return a})||[]},only:function(a){if(!L(a))throw Error(z(143));return a}};exports.Component=C;__webpack_unused_export__=E;__webpack_unused_export__=T;
exports.cloneElement=function(a,b,c){if(null===a||void 0===a)throw Error(z(267,a));var e=l({},a.props),d=a.key,k=a.ref,h=a._owner;if(null!=b){void 0!==b.ref&&(k=b.ref,h=G.current);void 0!==b.key&&(d=""+b.key);if(a.type&&a.type.defaultProps)var g=a.type.defaultProps;for(f in b)H.call(b,f)&&!I.hasOwnProperty(f)&&(e[f]=void 0===b[f]&&void 0!==g?g[f]:b[f])}var f=arguments.length-2;if(1===f)e.children=c;else if(1<f){g=Array(f);for(var m=0;m<f;m++)g[m]=arguments[m+2];e.children=g}return{$$typeof:n,type:a.type,
key:d,ref:k,props:e,_owner:h}};exports.createContext=function(a,b){void 0===b&&(b=null);a={$$typeof:r,_calculateChangedBits:b,_currentValue:a,_currentValue2:a,_threadCount:0,Provider:null,Consumer:null};a.Provider={$$typeof:q,_context:a};return a.Consumer=a};exports.createElement=J;__webpack_unused_export__=function(a){var b=J.bind(null,a);b.type=a;return b};__webpack_unused_export__=function(){return{current:null}};exports.forwardRef=function(a){return{$$typeof:t,render:a}};exports.isValidElement=L;
__webpack_unused_export__=function(a){return{$$typeof:v,_payload:{_status:-1,_result:a},_init:Q}};__webpack_unused_export__=function(a,b){return{$$typeof:u,type:a,compare:void 0===b?null:b}};__webpack_unused_export__=function(a,b){return S().useCallback(a,b)};exports.useContext=function(a,b){return S().useContext(a,b)};__webpack_unused_export__=function(){};__webpack_unused_export__=function(a,b){return S().useEffect(a,b)};__webpack_unused_export__=function(a,b,c){return S().useImperativeHandle(a,b,c)};
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => "b4d1346a3088f9473748"
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "webpack-eslint:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatewebpack_eslint"] = (chunkId, moreModules, runtime) => {
